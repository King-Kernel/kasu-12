...
clang_bin="$HOME/toolchains/clang-default/bin"

# 64-bit GCC toolchain prefix
gcc_prefix64="$HOME/toolchains/aarch64-linux-android/bin/aarch64-linux-android-"

# 32-bit GCC toolchain prefix
gcc_prefix32="$HOME/toolchains/arm-linux-androideabi/bin/arm-linux-androideabi-"
